    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('password', PasswordType::class, [
                'label' => 'admin.users.form.password',
                'attr' => [
                    'placeholder' => 'admin.users.form.password_placeholder',
                ],
                'constraints' => [
                    new NotBlank([
                        'message' => 'admin.users.validation.password_required',
                    ]),
                    new Length([
                        'min' => 6,
                        'minMessage' => 'admin.users.validation.password_too_short',
                    ]),
                ],
            ])
        ;
